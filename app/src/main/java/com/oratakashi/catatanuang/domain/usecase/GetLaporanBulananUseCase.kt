...
/**
 * Use case for retrieving a monthly financial report.
 *
 * @author oratakashi
 * @since 22 Mar 2026
 * @property repository The transaction repository.
 */
class GetLaporanBulananUseCase(private val repository: ITransaksiRepository) {

    /**
     * Returns a [Flow] of [LaporanSummary] for the month of the given [date].
     *
     * @param date Any date within the target month. Defaults to today.
     */
